    ...
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen">
          <img src="{{ asset('note/images/logo.png') }}" class="m-r-sm">自主學習系統</a>
              ...
              <div class="list-group list-group-alt animated fadeInRight">
                <a href="#" class="media list-group-item">
                  <span class="pull-left thumb-sm">
                    <img src="{{ asset('note/images/avatar.jpg') }}" alt="John said" class="img-circle"></span>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <span class="thumb-sm avatar pull-left">
              <img src="{{ asset('note/images/avatar.jpg') }}" ></span>
...
<!-- App -->
<script src="{{ asset('note/js/charts/easypiechart/jquery.easy-pie-chart.js') }}" cache="false"></script>
<script src="{{ asset('note/js/charts/sparkline/jquery.sparkline.min.js') }}" cache="false"></script>
<script src="{{ asset('note/js/charts/flot/jquery.flot.min.js') }}" cache="false"></script>
<script src="{{ asset('note/js/charts/flot/jquery.flot.tooltip.min.js') }}" cache="false"></script>
<script src="{{ asset('note/js/charts/flot/jquery.flot.resize.js') }}" cache="false"></script>
<script src="{{ asset('note/js/charts/flot/jquery.flot.grow.js') }}" cache="false"></script>
<script src="{{ asset('note/js/charts/flot/demo.js') }}" cache="false"></script>
<script src="{{ asset('note/js/calendar/bootstrap_calendar.js') }}" cache="false"></script>
<script src="{{ asset('note/js/calendar/demo.js') }}" cache="false"></script>
<script src="{{ asset('note/js/sortable/jquery.sortable.js') }}" cache="false"></script>
</body>
</html>