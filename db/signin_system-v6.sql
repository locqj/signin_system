...
INSERT INTO `days_matter` VALUES (1,'D1502334363r','考研倒計時',2017,12,24,1,'xxx'),(2,'D1502334375r','考研倒計時',2017,12,26,1,'xxx'),(3,'D1502920893r','test',2017,8,18,0,'xxx'),(4,'D1502921209r','test',2017,8,18,0,'xxx'),(5,'D1502921309r','test',2017,8,18,1,'xxx'),(6,'D1502921336r','test',2017,8,18,1,'xxx'),(7,'D1502921357r','test',2017,8,18,1,'xxx'),(8,'D1502921371r','test',2017,8,19,1,'xxx');
...
CREATE TABLE `image_log` (
  ...
  `status_log` int(11) NOT NULL COMMENT '1-首页轮播 2-活动页图片',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `image_log` VALUES (1,'xxx','2017-08-18-04-25-02-59966c1e2265e.jpg',0,1),(2,'xxx','2017-08-18-04-26-40-59966c804ce89.jpg',1,1),(3,'xxx','2017-08-18-04-27-48-59966cc432cca.jpg',0,1),(4,'xxx','2017-08-18-04-28-00-59966cd097751.jpg',0,1),(5,'xxx','2017-08-18-06-29-10-599689369544c.jpg',1,2),(6,'xxx','2017-08-18-07-11-45-5996933179207.jpg',1,1),(7,'xxx','2017-08-18-07-13-18-5996938e0eed5.jpg',1,1),(8,'xxx','2017-08-18-07-13-26-59969396c3ad9.jpg',1,1);
...
-- Dump completed on 2017-08-18 16:04:48
