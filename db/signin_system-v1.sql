...
--
-- Host: localhost
-- Generation Time: 2017-08-04 12:00:10
-- 服务器版本： 5.5.48-log
-- PHP Version: 7.0.7
...
--
-- Indexes for table `awark_rule`
--
ALTER TABLE `awark_rule`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `crontab_note`
--
ALTER TABLE `crontab_note`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `days_matter`
--
ALTER TABLE `days_matter`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `moon_calculate`
--
ALTER TABLE `moon_calculate`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sign_actions`
--
ALTER TABLE `sign_actions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sign_log`
--
ALTER TABLE `sign_log`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tag_calculate`
--
ALTER TABLE `tag_calculate`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `awark_rule`
--
ALTER TABLE `awark_rule`
...
ALTER TABLE `client_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `crontab_note`
--
ALTER TABLE `crontab_note`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `days_matter`
--
ALTER TABLE `days_matter`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `moon_calculate`
--
ALTER TABLE `moon_calculate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sign_actions`
--
ALTER TABLE `sign_actions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sign_log`
--
ALTER TABLE `sign_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tag_calculate`
--
ALTER TABLE `tag_calculate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
